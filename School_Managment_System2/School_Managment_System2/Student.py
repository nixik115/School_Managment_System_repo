...
class Student(Person):  # creating a new class which inherits from class User
    def __init__(self,first_name, last_name, email, phone_number, student_id, course_id):
        ...
        self.__student_id = student_id  # instance of the class  # instance of the class
        self.__course_id = course_id  # instance of the class
    ...
    def print_all_students_details(cursor, connection):  # this method is made to execute SQL query that selects all columns from Student table
